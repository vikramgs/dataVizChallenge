...
ax1.set_title("2010 Stadium Performance", fontsize=14, fontweight='bold', pad=15)
ax1.set_xlabel("Average Runs Per Game", fontsize=12)
ax1.set_ylabel("Stadium (Home Team)", fontsize=12)

ax2.set_title("2021 Stadium Performance", fontsize=14, fontweight='bold', pad=15)
...
# # Get Colorado values for statistics 
# colorado_runs_2010 = avgDF_2010_sorted[avgDF_2010_sorted.home == "COL"]["runs_2010"].iloc[0]
# colorado_runs_2021 = avgDF_2021_sorted[avgDF_2021_sorted.home == "COL"]["runs_2021"].iloc[0]             
...
ax1.annotate(f"COL: {colorado_runs_2010:.2f}", 
             ...
             xytext=(colorado_runs_2010 + 2, colorado_index_2010 + 19.8),
             arrowprops=dict(arrowstyle='->', color='darkorchid', lw=2),
             fontsize=10, fontweight='bold', color='darkorchid')
...
ax2.annotate(f"COL: {colorado_runs_2021:.2f}", 
             ...
             xytext=(colorado_runs_2021 + 2, colorado_index_2021 + 17.8),
             arrowprops=dict(arrowstyle='->', color='darkorchid', lw=2),
             fontsize=10, fontweight='bold', color='darkorchid')
